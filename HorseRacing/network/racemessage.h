...
public:
     ...
     */
    static QByteArray createPositions(const QVector<float>& horsePositions, const float& cameraPosition);
    /**
     ...
     */
    static void parsePositions(const QByteArray& message, QVector<float>& horsePositions, float& cameraPosition);
};
